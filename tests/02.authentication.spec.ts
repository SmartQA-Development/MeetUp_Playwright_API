...
test('AUTH - 01 - User logs in to the MyAccount page', async ({page }) => {
...
test('AUTH - 02 - ANSWER - BrowserContext - User should be logged in', async ({browser }) => {
...
test.describe('AUTH - 03 - ANSWER - Grouped', () => {
    test.use({ storageState: 'playwright/.auth/user.json' });
